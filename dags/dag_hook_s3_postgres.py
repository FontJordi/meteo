...
with DAG(
    ...
    create_meteo_table = PostgresOperator(
        ...
        sql="""
            CREATE TABLE IF NOT EXISTS meteo_insert (
            idcode                    VARCHAR ,
            coord_lon                 VARCHAR,
            coord_lat                 VARCHAR,
            weather_id                VARCHAR,
    ...
    create_meteo_hist_table = PostgresOperator(
        task_id="create_meteo_table",
        sql="""
    ...
    create_meteo_table>>create_meteo_hist_table>>transfer_s3_to_sql
